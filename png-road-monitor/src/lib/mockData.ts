...
export const mockGPSEntries: MockGPSEntry[] = [
  ...
  },
  {
    ...
    startChainage: '7+200',
    endChainage: '7+800',
    taskDescription: 'Bridge foundation and abutment construction over Kagamuga Creek',
    photos: [],
  ...
  },
  {
    ...
    startChainage: '8+400',
    endChainage: '9+200',
    taskDescription: 'Main flyover structural work and approach road construction',
    photos: [],
